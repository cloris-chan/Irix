...
public sealed class PatchBatch : IDisposable
{
    ...
    public PatchBatch(VirtualNode root, IMemoryOwner<VirtualNodePatch> owner, int count, int screenId = 0, TextBufferSnapshot textSnapshot = default, TextBufferSnapshot prevTextSnapshot = default, VirtualNode previousRoot = default)
        : this(root, owner, count, screenId, PatchBatchKind.Diff, textSnapshot, prevTextSnapshot, previousRoot)
    {
    }

    public PatchBatch(VirtualNode root, IMemoryOwner<VirtualNodePatch> owner, int count, int screenId, PatchBatchKind kind, TextBufferSnapshot textSnapshot = default, TextBufferSnapshot prevTextSnapshot = default, VirtualNode previousRoot = default)
    {
        ...
        PrevTextSnapshot = prevTextSnapshot;
    ...
    public TextBufferSnapshot PrevTextSnapshot { get; }

    public VirtualNode PreviousRoot { get; }
