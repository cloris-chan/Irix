...
internal static class PartialApplyIntegrationGateChecklist
{
    ...
    [
        ...
        new(
            ...
            "Production-owner feed tests cover default-off no allocation, enabled full apply, fallback full, rebuild, and runtime-owner disposal without making the owner a render source.",
        ...
        new(
            ...
            "Production-owner feed runs planner to root patch to owner partial accept, reports fallback while preserving owner state before fallback when rehearsal fails, and then explicitly full-applies fallback state.",
        ...
        new(
            ...
            "Production-off no-change tests prove the feed does not alter DrawingBackendCompositor counters, backend Execute calls, hit-test results, or diagnostics text; enabled tests prove rendering still executes the normal full-frame batch.",
        ...
        new(
            ...
            "Production-off tests cover default-off equivalence, enabled owner feed, accepted partial rehearsal, fallback, rebuild, compositor probe hardening, dirty-range isolation, throw path, clipped hit-test, and diagnostics text no-change.",
