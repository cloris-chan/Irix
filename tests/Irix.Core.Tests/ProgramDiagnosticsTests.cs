...
public sealed class ProgramDiagnosticsTests
{
    ...
    public void Glyph_atlas_cache_uses_stable_entry_handles()
    {
        ...
        Assert.Contains("private GlyphAtlasPageHandle _pendingAtlasPageReuse;", glyphSource);
        ...
        Assert.Contains("private GlyphAtlasPage? SelectWritableAtlasPage(int width, int height)", glyphSource);
