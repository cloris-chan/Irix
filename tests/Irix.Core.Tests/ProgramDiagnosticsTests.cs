...
public sealed class ProgramDiagnosticsTests
{
    ...
    public void Glyph_atlas_cache_uses_stable_entry_handles()
    {
        ...
        Assert.Contains("RequirePointer(factory2, \"D3D12GlyphAtlasTextRenderer.QueryInterface(IDWriteFactory2) returned a null factory.\");", glyphSource);
        ...
        Assert.Contains("GlyphAtlasTextCompositionHelpers.HasGlyphDirectWriteResources(_dwriteFactory != null, _dwriteFactory2 != null, _fontCollection != null, _textAnalyzer != null, _fontFallback != null)", glyphSource);
