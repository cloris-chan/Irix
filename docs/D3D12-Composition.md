...
- Typed composition clock values: `CompositionTimestamp` and `CompositionDuration` carry high-precision Irix `CompositionClock` ticks and keep frame indexes, present counters, and refresh-rate ticks out of animation progress.
