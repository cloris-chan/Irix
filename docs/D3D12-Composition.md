...
- A `--diagnose-scroll-presentation-hittest` diagnostic that routes fixed pointer input through active fixed-clip scroll presentation and then dispatches hover refresh while presentation remains active.
