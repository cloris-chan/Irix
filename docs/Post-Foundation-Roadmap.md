...
| Scroll/compositor bridge | Use scroll as the first hybrid case: runtime owns logical target; compositor owns presented offset. | [Animation-Composition-v0.md](Animation-Composition-v0.md), [D3D12-Composition-Spike-v0.md](D3D12-Composition-Spike-v0.md) | Single fixed-clip presentation exists; nested/mixed-clip scroll and runtime commit/cancel policy remain. |
