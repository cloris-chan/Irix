...
9. Next: add batch cancellation, commit, and active presentation-set completion policy before Counter multi-target routing.
10. Only then allow Counter multi-target control-state deltas to use concurrent transitions instead of the current abort-and-normal-dispatch path.
