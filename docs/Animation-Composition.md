...
10. Done: active presentation-set completion pump preflight drains per-layer completion markers, commits completed owners in the owner table, preserves remaining owners, and clears the active presentation plan only after the last tracked owner completes.
