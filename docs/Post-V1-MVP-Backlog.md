...
- No fallback font identity, color glyphs, SDF/MSDF, or shaped wrapping support in the atlas path. First shaped drawing is limited to single-face `NoWrap` runs with nonzero glyph indices.
