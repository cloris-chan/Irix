...
- BiDi/shaping oracle coverage now pins the current resolved-level visual-order helper with nested examples. A DirectWrite-layout pixel or glyph-run oracle remains a P2 production-quality correctness task.
