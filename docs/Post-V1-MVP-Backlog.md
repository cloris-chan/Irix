...
- Glyph atlas diagnostics report total plus Alpha/Bgra page counts, fixed page budget, page dimensions, total atlas pixel capacity, resident CPU shadow bytes, resident D3D12 upload-buffer bytes, resident D3D12 texture bytes, total and Alpha/Bgra completed and pending next-frame reuse counts, scheduled page reuse requests, hard AtlasFull-without-reuse counts, total and Alpha/Bgra used glyph bitmap pixels, total and Alpha/Bgra shelf fragmentation estimates, atlas record serial, total and format-split oldest page age metrics, upload bytes, uploaded glyph count, accepted color layer/bitmap run counts, shaped/raster scratch bytes and reset-scoped resize counts, and split color/complex degradation reasons for future page-size, BGRA pressure, LRU, and unsupported-text policy decisions.
