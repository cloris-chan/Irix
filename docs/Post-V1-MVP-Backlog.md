...
- D3D12 rectangle and glyph-atlas upload map paths unmap in `finally` after a successful map. Glyph-atlas vertex upload, page upload, and draw paths guard missing GPU resources as typed record failures.
