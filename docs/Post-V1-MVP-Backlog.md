...
| POST-011 | Resource cache / stable global handles | Entry/page handles, page-owned SRV resources, next-frame single-page reuse, page usage diagnostics, and atlas touch serials done | D3D12-specific; align with glyph atlas resource ownership and eviction work |
...
- Resource cache / stable handles: continue POST-011 from touch serial and page age diagnostics toward explicit multi-page LRU policy before widening non-overlay text coverage.
