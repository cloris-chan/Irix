...
- D3D12 rectangle and glyph-atlas upload map paths unmap in `finally` after a successful map. Glyph-atlas upload/draw paths guard missing page texture/upload/SRV resources as typed record failures.
