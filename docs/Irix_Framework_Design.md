...
6. Render-target-backed layer reuse for transform-with-content rect/GlyphAtlas text command-order layers; fixed-clip scroll needs content-space target bounds before it can use this cache.
