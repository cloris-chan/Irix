...
Scope: local validation that glyph atlas diagnostics expose resident CPU shadow bytes, resident D3D12 upload-buffer bytes, and resident D3D12 atlas texture bytes while the renderer remains D3D12-only.
