...
D3D12 overlay fallback setup now guards D3D11On12/D2D/DirectWrite COM creation and releases DXGI/D2D/frame-wrapping intermediates on constructor or resize recreation failure.
