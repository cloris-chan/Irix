...
| Not implemented | DirectWrite shaped-run conversion, fallback font identity, color glyphs, surrogate pairs, combining marks, hyphenation/complex wrapping, full LRU/entry-level eviction, and recovery beyond explicit degradation |
