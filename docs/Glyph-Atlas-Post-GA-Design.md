...
Glyph-atlas record-time resource guards classify missing glyph vertex upload buffer and atlas texture/upload/SRV resources as typed record failures instead of allowing null GPU resource binding.
