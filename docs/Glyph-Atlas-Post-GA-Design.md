...
| Atlas format | Active path uses `R8_UNORM` alpha atlas pages; atlas page resources already carry an explicit format/row-pitch/DXGI descriptor split for future `B8G8R8A8_UNORM` bitmap color glyph pages |
