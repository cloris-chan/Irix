...
| 6 | Glyph and allocation discipline | Run glyph Smoke for broad rendering changes. Keep allocation optimization paused unless a written ownership design names one measured bucket and proves retained publication safety. |
