...
| 5 | Public style/transition contract | Internal typed style delta planning and pure opacity/translation declaration precompile exist. Next slice should define how future public semantic style/transition authoring feeds this internal layer without exposing layout/visual/composition categories, adding theme/cascade, or creating a scheduler before runtime ownership is written. |
