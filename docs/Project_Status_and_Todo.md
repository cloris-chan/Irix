...
| P1 | Attribute warm glyph atlas allocation | Latest corrected `--diagnose-text-cache 30` scroll sample is `2793 bytes/frame`, mostly translate/tree attribution. Optimize from that evidence; renderer submit is not the primary target. |
