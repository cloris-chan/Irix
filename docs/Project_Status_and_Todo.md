...
| Retained / partial apply prep | ✅ preflight scaffold 完成：每个 local reason 有 regression test；resource segment / lifecycle model、hit target projector、integration gate checklist 均为 internal/test-only；cross-frame resources 仍 blocked |
