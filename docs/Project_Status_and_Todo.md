...
| Performance | Pre-GA micro-optimization is closed. Latest `--diagnose-text-cache 180` warm scroll baseline is `394248 bytes`, `2190 B/frame`: top level `tree=592`, `diff=273`, `translate=1093`, `render=273` B/frame; detail `tree.buildRoot=410`, `tree.snapshot=136`, `pipeline.layout=455`, `pipeline.snapshot=227`, `record=91` B/frame. Current largest candidate is `pipeline.layout`; record allocation is not the next target. |
