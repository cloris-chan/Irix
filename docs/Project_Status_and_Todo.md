...
| Performance | Pre-GA micro-optimization is closed. Latest `--diagnose-text-cache 180` warm scroll baseline with layout attribution is about `394248 bytes`, `2190 B/frame`: `pipeline.layout=455` B/frame, split into `elementsArray=227`, `treeNodesArray=182`, `scrollDiagnosticsArray=45`, `result=0`, `dirtyRanges=0`, `nodeWalk=0` B/frame. `tree.buildRoot` is about `410 B/frame`, `pipeline.snapshot` about `227 B/frame`, and record about `91 B/frame`; record allocation is not the next target. |
