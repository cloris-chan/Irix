...
| P1 | Broaden render-target-backed layer reuse | D3D12 now caches rect/GlyphAtlas text command-order layers into RTV/SRV textures and composites them back with textured quads without replaying stable payloads. Next expand to image/vector-capable layer contents. |
