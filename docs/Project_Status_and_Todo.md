...
| P1 | Broaden render-target-backed layer reuse | D3D12 now caches rect/GlyphAtlas text suffix layers into RTV/SRV textures and composites them back with textured quads. Next expand to image/vector-capable layer contents and interleaved ordering without replaying stable payloads. |
