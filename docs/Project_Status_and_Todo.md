...
| P1 | Broaden render-target-backed layer reuse | First D3D12 slice caches rect-only suffix layers into RTV/SRV textures and composites them back with textured quads. Next expand to text/image/vector-capable layer contents and interleaved ordering without replaying stable payloads. |
