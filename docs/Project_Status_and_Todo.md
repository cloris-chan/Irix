...
| P1 | Layer caching / retained composition target cache | Nested/mixed scroll now decomposes into ordered layers. Next GPU-side payoff is caching stable layer content instead of replaying retained draw commands for every compositor tick. |
