...
| P1 | Scroll presentation producer hardening | Main app wheel input now starts compositor scroll presentation ticks. Next harden cancellation, resize/layout-change cancellation, and diagnostics for producer fallback paths. |
