...
| P1 | Public style/transition authoring contract | Internal style delta planning and pure opacity/translation declaration precompile exist. Next useful style slice should define the public semantic authoring contract and runtime transition ownership without exposing layout/visual/composition processing categories, adding theme/cascade, or turning diagnostics into a scheduler. |
